...
PLACE_HINTS = {
    # Marmara
    "istanbul": (41.02, 28.97),
    "silivri": (41.07, 28.25),
    "büyükçekmece": (41.02, 28.58),
    "şile": (41.18, 29.60),
    "adalar": (40.86, 29.09),
    "tuzla": (40.82, 29.30),
    "yalova": (40.66, 29.28),
    ...
    "erdek": (40.40, 27.79),
    "balıkesir": (40.35, 27.97),
    "marmara adası": (40.59, 27.56),
    "tekirdağ": (40.98, 27.51),
    "marmaraereğli": (40.97, 27.95),
    "şarköy": (40.61, 27.11),
    "gelibolu": (40.41, 26.67),
    # Çanakkale / Kuzey Ege
    "çanakkale": (40.15, 26.41),
    "gökçeada": (40.19, 25.90),
    "bozcaada": (39.83, 26.06),
    "ayvacık": (39.60, 26.40),
    "edremit": (39.59, 26.94),
    "ayvalık": (39.31, 26.69),
    "dikili": (39.07, 26.89),
    ...
    "hatay": (36.20, 35.95),
    "samandağ": (36.08, 35.95),
    # Karadeniz
    "kıyıköy": (41.64, 28.10),
    "kırklareli": (41.64, 28.10),
    "karasu": (41.11, 30.68),
    "kdz ereğli": (41.28, 31.42),
    "ereğli": (41.28, 31.42),
    "zonguldak": (41.45, 31.79),
    "bartın": (41.63, 32.34),
    "amasra": (41.75, 32.39),
    "kastamonu": (41.92, 33.77),
    "inebolu": (41.98, 33.76),
    "sinop": (42.03, 35.15),
    "samsun": (41.29, 36.33),
    "ordu": (41.00, 37.87),
    ...
    "girne": (35.34, 33.32),
    "gazimağusa": (35.12, 33.94),
    "lefkoşa": (35.19, 33.36),
    # bare sea names: a headline often says only "Marmara'da" or "Ege'de"
    "marmara": (40.75, 28.30),
    "ege": (38.60, 26.20),
    "akdeniz": (36.20, 30.50),
    "karadeniz": (41.80, 32.00),
    "boğaz": (41.10, 29.05),
    "istanbul boğazı": (41.10, 29.05),
